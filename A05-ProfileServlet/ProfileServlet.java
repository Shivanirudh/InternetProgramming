...
public class ProfileServlet extends HttpServlet{
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
            ...
            out.println("<html><head><link rel='stylesheet' href='styles_profile.css'></head><body>");
            out.println("<h1><B>Welcome " + name + " to the profile page!!</B></h1>");
            out.println("<br><br>");
            out.println("<table>");
            while (rs.next()) {
            ...
            out.println("<form id='logoutform' action='http://localhost:8080/A05-ProfileServlet/LogoutServlet'>");
            out.println("<input type='submit' value='Logout' id='submit'>");
            out.println("</form>");
